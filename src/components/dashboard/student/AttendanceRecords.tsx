...
import { studentAttendance } from '@/data/dashboardData'
  ...
  return (
    <div className="space-y-8">
      <div>
        ...
        <p className="mt-1 text-sm text-ink-500">Your personal attendance history.</p>
      </div>

      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
        {studentAttendance.summary.map((stat) => (
