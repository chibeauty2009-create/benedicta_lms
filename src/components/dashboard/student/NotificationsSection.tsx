...
import { studentNotifications } from '@/data/dashboardData'
  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-wrap items-center justify-between gap-4">
        <div>
          <h2 className="font-display text-lg font-semibold text-ink-900">Notifications</h2>
          <p className="mt-1 text-sm text-ink-500">Real-time updates as they happen.</p>
        </div>
        {unreadCount > 0 && (
          <button
            onClick={markAllRead}
